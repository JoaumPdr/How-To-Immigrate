 ...
 * Responsivo (1 coluna no mobile, 4 colunas no desktop) e acessível.
 */
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-slate-50 dark:bg-slate-950/40">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold tracking-tight">HowToImmigrate</span>
            </Link>
            <p className="text-sm text-muted-foreground leading-normal">
              Compare países por custo de vida, visto, segurança e mercado de trabalho para planejar sua jornada de imigração.
            </p>
          </div>

          {/* Coluna 2: Links Rápidos */}
          <div>
            <h3 className="text-sm font-semibold tracking-wider uppercase mb-4">Navegar</h3>
          ...
          {/* Coluna 4: Redes & Idioma */}
          <div className="flex flex-col gap-4">
            <h3 className="text-sm font-semibold tracking-wider uppercase">Idioma</h3>
            <div>
              <LanguageSwitcher />
            </div>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {currentYear} HowToImmigrate. Todos os direitos reservados.
          </p>
          <p className="text-xs text-muted-foreground">
            Feito com 💙 para futuros imigrantes.
          </p>
        </div>
      </div>
    </footer>
